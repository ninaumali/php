  ...
  <div class="modal-body">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        ...
        <select name="user__province" class="form-control form-control-md" id="province" required></select>
      ...
      <div class="form-group col-md-6">
        ...
        <select name="user__city" class="form-control form-control-md" id="city" required></select>
